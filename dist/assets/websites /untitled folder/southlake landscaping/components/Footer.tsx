      ...
      <div className="bg-gradient-to-r from-forest-800 to-forest-700">
        <div className="container-custom py-12 px-4 text-center">
          ...
          <p className="text-forest-100 text-lg mb-8 max-w-2xl mx-auto">
            Get a free consultation and estimate for your landscaping project. We serve Grapevine and surrounding communities.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <div className="mb-6 flex items-center gap-3">
              <img
                src="/logo/grapevine-icon.png"
                alt=""
                className="h-12 w-auto object-contain"
              />
              <span className="font-display font-bold text-2xl text-white">
                Grapevine Landscaping
              </span>
            </div>
            <p className="text-stone-400 mb-6 leading-relaxed">
              Premier landscaping and hardscaping services in Grapevine, Texas and surrounding communities. Quality craftsmanship, attention to detail, and customer satisfaction guaranteed.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.slice(0, 10).map((service) => (
                <li key={service.slug}>
                  <Link 
                    href={`/cities/grapevine/services/${service.slug}`}
