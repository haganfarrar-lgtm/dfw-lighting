...
export default function CityPage({ params }: CityPageProps) {
  ...
  const cityFaqs = [
    ...
    },
    {
      ...
      answer: `In addition to ${city.name}, we serve ${nearbyCities.map(c => c.name).join(', ')}, and other communities within 50 miles of Southlake. Our central location allows us to efficiently serve the entire DFW metroplex.`
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateBreadcrumbSchema([
            { name: 'Home', url: '/' },
            { name: 'Service Areas', url: '/cities/southlake' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-stone-50 rounded-2xl p-8 border border-stone-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-3 border-b border-stone-200">
                  <span className="text-stone-600">Distance from Grapevine</span>
